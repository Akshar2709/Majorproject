                                ...
                                <!--<div class="search-pagination text-center">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        for ($i = 1; $i <= $total_page; $i++) {
                                            if ($i == $page) {
                                                echo "<li class='page-item active'><a class='page-link' href='mysoldnotes.php?page=$i'>$i</a></li>";
                                            } else echo "<li class='page-item'><a class='page-link' href='mysoldnotes.php?page=$i'>$i</a></li>";
                                        }
                                        echo "<li class='page-item'><a onclick=" . "showNotes($page+1)" . " class='page-link'>❯</a></li>";*/
                                        ?>
                                    </ul>
